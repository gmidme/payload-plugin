...
package com.yufei.elasticsearch.rescore;
import com.yufei.elasticsearch.payload.PayloadSearchQueryBuilder;
import org.elasticsearch.plugins.AnalysisPlugin;

import com.yufei.elasticsearch.plugin.PayloadPlugin;
...
public class PayloadIT extends ESIntegTestCase {
    ...
    protected Collection<Class<? extends Plugin>> nodePlugins() {
        return Collections.singletonList(PayloadPlugin.class);
    }

    public void testEmptyIndex() throws IOException {
        Settings indexSettings = Settings.builder().put(SETTING_NUMBER_OF_SHARDS, 1)
                .put("analysis.analyzer.payload_delimiter.tokenizer", "whitespace")
                .put("analysis.analyzer.payload_delimiter.filter.0", "delimited_payload").build();
        assertAcked(prepareCreate("image_test")
                .setSettings(indexSettings)
                .addMapping("image",
                        jsonBuilder()
                        .startObject().startObject("image").startObject("properties")
                        .startObject("kwPayloads")
                                .field("type", "text")
